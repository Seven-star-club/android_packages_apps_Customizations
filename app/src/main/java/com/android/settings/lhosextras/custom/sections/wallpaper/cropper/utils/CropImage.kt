...
import com.android.settings.lhosextras.custom.sections.wallpaper.cropper.CropImageView.*
import com.android.settings.lhosextras.custom.sections.wallpaper.cropper.WallpaperCropperActivity
import java.io.File
import java.util.*
 ...
 * question](http://stackoverflow.com/questions/32789027/android-m-camera-intent-permission-bug).
    ...
    class ActivityBuilder(
        ...
        fun getIntent(context: Context): Intent {
            return getIntent(context, WallpaperCropperActivity::class.java)
        }
