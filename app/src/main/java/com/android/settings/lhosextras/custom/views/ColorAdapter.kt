...
import com.android.settings.lhosextras.custom.utils.isColorDark
import com.android.settings.lhosextras.custom.utils.resolveColor
import com.android.settings.lhosextras.custom.utils.resolveColorAttr
...
internal class ColorAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ColorItemViewHolder {
        ...
        val color = inflater.inflate(R.layout.item_color, parent, false)
