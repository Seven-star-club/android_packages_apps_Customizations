...
@JvmOverloads constructor(context: Context?, attrs: AttributeSet? = null) : View(context, attrs) {
    ...
    /**
     * The shape of the cropping area - rectangle/circular.
     */// return hardware acceleration back// TURN off hardware acceleration
    /**
     * The shape of the cropping area - rectangle/circular.
     */
    ...
    private fun initCropWindow() {
        ...
        if (mInitialCropWindowRect.width() > 0 && mInitialCropWindowRect.height() > 0) {
            ...
            if (bitmapAspectRatio > mTargetAspectRatio) {
                ...
                val cropWidth =
                    Math.max(mCropWindowHandler.minCropWidth, rect.height() * mTargetAspectRatio)
                ...
                // Limits the aspect ratio to no less than 40 wide or 40 tall
                val cropHeight =
                    Math.max(mCropWindowHandler.minCropHeight, rect.width() / mTargetAspectRatio)
